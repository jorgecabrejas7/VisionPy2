...
class Plugin(BasePlugin):
    ...
    def compare_slices_concurrent_ai(self,volume1, volume2,length,resolution,start=0,end=-1, n_chunks = 100,range_slices=200):
        """
        ...
        def pad_and_crop_image(image, square_size):
            ...
            for i in range(0, resized_image.shape[0], square_size):
                for j in range(0, resized_image.shape[1], square_size):
                    cropped_images.append(resized_image[i:i+square_size, j:j+square_size])
