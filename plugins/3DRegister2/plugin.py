...
class Plugin(BasePlugin):
        ...
        if file_path and file_path2:
            ...
            if len([1]) > 0:
                ...
                if save_path:
                    ...
                    image_sequence.write_sequence2(save_path, os.path.basename(save_path), sitk.GetArrayFromImage(final_top_2),progress_window=self)
    ...
    def get_roi(self,vol):
        ...
        rectangle_width = int(shape[2] * 0.24)
